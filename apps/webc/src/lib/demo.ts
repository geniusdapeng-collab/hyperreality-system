...
export const demoNotifications: NotificationItem[] = [
  {
    ...
    payload: { ticketId: "TK-20260822-101", title: "售后退换：保温杯杯盖密封圈更换" },
    createdAt: "2026-08-22T19:42:10.000Z",
    read: false,
  },
  {
    kind: "ticket.completed",
    payload: { ticketId: "TK-20260821-087", title: "物流催办：订单 XM-20881 三天未更新" },
...
export function demoChatAnswer(text: string): {
  ...
  return {
    intent: "fallback",
    answer: "这个问题我还在学习中，已为您转专人处理，稍后会有客服专员与您联系。您也可以直接描述需要的售后、物流或其他服务。",
    confidence: 0.42,
    citations: [],
  };
}
