...
async function test() {
  ...
  // 使用ScriptGenerator的实际prompt（从之前的诊断获取）
...
[
  ...
  },
  {
    ...
    "description": "冲突升级、角色成长、多线交织"
  },
  {
    "act_id": "ACT-3",
    "act_name": "第三幕：解决",
    "act_function": "resolve",
    "description": "高潮对决、真相揭示、收尾"
  }
]
...
## 创意指数指导（创意指数 = 0.7）
增强创意：鼓励非传统叙事结构、情绪曲线设计、视觉隐喻


## 视觉表现指导
运用电影级镜头语言，重视光影质感与情绪表达


请直接输出JSON，不要任何其他文字。`;

  console.log('[TEST] Prompt长度:', prompt.length);
  console.log('[TEST] 使用maxTokens=8192, timeoutMs=300000调用...');
